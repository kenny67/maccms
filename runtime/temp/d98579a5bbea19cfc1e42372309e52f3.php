<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"E:\soft\wampServer64\www\maccms/application/admin\view\index\login.html";i:1582533410;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="/maccms/static/layui/css/layui.css">
    <link rel="stylesheet" href="/maccms/static/css/admin_style.css">
    <style type="text/css">
        body {
            color:#999;
...
<div class="login-box">
    <form class="layui-form layui-form-pane" method="post" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="number" name="verify" class="layui-input" lay-verify="verify" placeholder="验证码" maxlength="4"  max="9999"/><img id="verify_img" src="/maccms/index.php/verify/index.html" onclick="this.src = this.src+'?'">
            </div>
        </div>
        <?php endif; ?>
...
<script type="text/javascript" src="/maccms/static/layui/layui.js"></script>
