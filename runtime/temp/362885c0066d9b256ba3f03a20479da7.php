<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"E:\soft\wampServer64\www\maccms/application/admin\view\index\index.html";i:1582533410;s:71:"E:\soft\wampServer64\www\maccms\application\admin\view\public\head.html";i:1582533410;s:71:"E:\soft\wampServer64\www\maccms\application\admin\view\public\foot.html";i:1582533410;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="/maccms/static/layui/css/layui.css?v=1020">
    <link rel="stylesheet" href="/maccms/static/css/admin_style.css?v=1020">
    <script type="text/javascript" src="/maccms/static/js/jquery.js?v=1020"></script>
    <script type="text/javascript" src="/maccms/static/layui/layui.js?v=1020"></script>
    <script>
        var ROOT_PATH="/maccms",ADMIN_PATH="<?php echo $_SERVER['SCRIPT_NAME']; ?>", MAC_VERSION='v10';
    </script>
</head>
<body>
...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        ...
        <ul class="layui-nav fr nobg head-info" lay-filter="">
            ...
            <li class="layui-nav-item"><a href="/maccms/" target="_blank">网站首页</a></li>
...
<script type="text/javascript" src="/maccms/static/js/admin_common.js"></script>
<!--请在下方写此页面业务相关的脚本-->
<script>
