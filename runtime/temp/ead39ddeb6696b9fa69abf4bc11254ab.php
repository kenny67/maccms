<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"E:\soft\wampServer64\www\maccms/application/admin\view\conch\theme.html";i:1583560610;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <script type="text/javascript" src="/maccms/static/js/jquery.js"></script>
    <script type="text/javascript" src="/maccms/static/layui/layui.js"></script>
    <script>var ROOT_PATH="/maccms",ADMIN_PATH="<?php echo $_SERVER['SCRIPT_NAME']; ?>", MAC_VERSION='v10';</script>
